 ...
 */
public class Cost {
    private String CityName; //发出城市名字
    ...
    public Cost(String CityName, String Chengdu, String Chongqing, String Changsha, String Wuhan, String Guangzhou, String Hangzhou, String Nanjing, String Shanghai) {
